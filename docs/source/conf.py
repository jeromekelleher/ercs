# -*- coding: utf-8 -*-
#
# ercs documentation build configuration file, created by
...
project = u'ercs'
copyright = u'2012, Jerome Kelleher'
...
latex_documents = [
  ('index', 'ercs.tex', u'ercs Documentation',
